package com.example.campusrider_customer.Grocery.ui.HelpCenter;
...
import com.example.campusrider_customer.databinding.FragmentFoodHelpBinding;
import com.example.campusrider_customer.databinding.FragmentHelpBinding;
...
public class HelpFragment extends Fragment {
    ...
    private void getQs(Context context) {
        ...
        StringRequest request=new StringRequest(Request.Method.GET, "http://campusriderbd.com/Customer/customer/help.php?cat=grocery", new Response.Listener<String>() {
            @Override
