...
import com.example.campusrider_customer.models.LoginResponse;
import com.example.campusrider_customer.models.User;
...
public class LoginActivity extends AppCompatActivity {
    ...
    Button login;
    int customer_id;
    String customer_name,username,address,customer_phone,customer_email,customer_password,student_id,id_card_front,customer_status,area=null;
                                ...
                                try {
                                    ...
                                    if(result.equals("Login Success")) {
                                        ...
                                        for (int i = 0; i < jsonArray.length(); i++) {
                                            ...
                                            sharedPrefManager.saveUser(new User(customer_id, customer_name, username, address, customer_phone,customer_email, customer_password, student_id,id_card_front,customer_status,area));
