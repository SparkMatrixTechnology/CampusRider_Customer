...
import com.example.campusrider_customer.Food.activity.MyOrderDetailsActivity;
...
import com.example.campusrider_customer.databinding.OrderListBinding;
...
public class MyOrderAdapter extends RecyclerView.Adapter<MyOrderAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new MyOrderAdapter.ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.order_list,parent,false));
    }
